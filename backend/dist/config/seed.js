...
const seedDatabase = async () => {
    try {
        ...
        await AIReport_1.default.deleteMany({});
        await TrustScore_1.default.deleteMany({});
        await Donation_1.default.deleteMany({});
        console.log('[Seeder] Cleared database collections.');
        // 1. Create Demo Seller (seller@amazonresell.com)
        const seller = await User_1.default.create({
            name: 'John Seller',
        ...
        const buyer = await User_1.default.create({
            name: 'Alice Buyer',
        ...
        const jane = await User_1.default.create({
            name: 'Jane Smith',
        ...
        // Seed Trust Scores
        await TrustScore_1.default.create([
            {
                user: seller._id,
                score: 94,
                factors: [
        ...
        // Phone
        const orderIPhone = await Order_1.default.create({
            user: seller._id,
        ...
        // Laptop
        const orderMacBook = await Order_1.default.create({
            user: seller._id,
        ...
        // Headphones
        const orderSony = await Order_1.default.create({
            user: seller._id,
        ...
        // Furniture
        const orderChair = await Order_1.default.create({
            user: seller._id,
        ...
        const janeOrderIPhone = await Order_1.default.create({
            user: jane._id,
            productName: 'iPhone 14 (128 GB) - Blue',
            brand: 'Apple',
            category: 'Electronics',
        ...
        const janeOrderSony = await Order_1.default.create({
            user: jane._id,
            productName: 'Sony WH-1000XM5 Wireless Noise Cancelling Headphones - Black',
            brand: 'Sony',
            category: 'Electronics',
        ...
        // iPhone 14
        const reportJaneIPhone = await AIReport_1.default.create({
        ...
        await Listing_1.default.create({
        ...
        // Sony WH-1000XM5
        const reportJaneSony = await AIReport_1.default.create({
        ...
        const reportSellerChair = await AIReport_1.default.create({
            conditionCategory: 'Excellent',
            conditionScore: 92,
            confidenceScore: 90,
            detectedIssues: [],
        ...
        await FlashDeal_1.default.deleteMany({});
        console.log('[Seeder] Cleared flash deals.');
        await FlashDeal_1.default.create([
            {
