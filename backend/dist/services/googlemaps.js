...
exports.discoverNearbyOrganizations = exports.calculateDonationMatchScore = exports.geocodeAddress = exports.getHaversineDistance = void 0;
// Fallback seed data
...
const geocodeAddress = (address, zipCode) => {
    let lat = 28.6304;
    let lng = 77.2177;
...
const calculateDonationMatchScore = (category, conditionScore, distanceKm, orgName, orgType, beneficiaries) => {
...
exports.calculateDonationMatchScore = calculateDonationMatchScore;
// Discover nearby organizations progressively
const discoverNearbyOrganizations = async (userAddress, userZip, category, conditionScore) => {
    const userCoords = (0, exports.geocodeAddress)(userAddress, userZip);
    const radii = [25, 50, 100];
    let matches = [];
    let found = false;
    for (const radius of radii) {
        const list = SEED_ORGANIZATIONS.map(org => {
            const distanceKm = (0, exports.getHaversineDistance)(userCoords.lat, userCoords.lng, org.lat, org.lng);
            return {
                ...org,
                distanceKm
            };
    ...
    const finalOrgs = matches.map(org => {
        const score = (0, exports.calculateDonationMatchScore)(category, conditionScore, org.distanceKm, org.name, org.type, org.estimatedBeneficiaries);
        return {
            name: org.name,
            type: org.type,
            address: org.address,
...
exports.discoverNearbyOrganizations = discoverNearbyOrganizations;
